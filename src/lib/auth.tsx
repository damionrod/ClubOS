...
interface AuthContextValue {
  ...
  signUp: (email: string, password: string, firstName: string, lastName: string, organisationId?: string, teamId?: string, subscriptionTypeId?: string) => Promise<{ error: string | null }>;
